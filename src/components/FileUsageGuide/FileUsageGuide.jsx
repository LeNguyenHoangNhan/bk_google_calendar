    ...
    return <div className={'file-usage-guide_wrapper'}>
        ...
        <div className={`file-usage-guide ${showDetails ? 'file-usage-guide-show' : 'file-usage-guide-hide'}`}>
            <section className="faq-section">
                ...
                n<h3>Với các bạn sử dụng điện thoại thông minh.</h3>
                <ol>
            ...
            <section className="faq-section">
                <h2>Mình gặp lỗi khi sử dụng, phần mềm xuất kết quả không đúng.</h2>
                <p>Mình rất tiếc phải nghe điều này. Bạn có thể cho mình biết tại <a href="https://www.facebook.com/hoangnhan.lenguyen.716/" target="_blank" rel="noopener noreferrer" className='link'>Facebook</a> của mình nhé. Mình rất mong nhận được sự phản hồi của bạn.</p>
            </section>
